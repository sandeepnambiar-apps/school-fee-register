-- Fix remaining FLOAT columns to DECIMAL(10,2)
-- This script fixes the remaining schema validation errors
...
WHERE TABLE_SCHEMA = 'school_fee_register' 
    ...
    AND COLUMN_NAME IN ('amount', 'discount_value', 'grade')
ORDER BY TABLE_NAME, COLUMN_NAME;

-- Show that no FLOAT columns remain
SELECT 
    TABLE_NAME, 
    COLUMN_NAME, 
    DATA_TYPE 
